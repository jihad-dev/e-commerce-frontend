...
const ViewProductFullDetails = () => {
    ...
    const { data: products, isLoading, isError, error } = useGetProductByIdQuery(id);
    ...
    if (isError) {
        ...
        return <div className="flex justify-center items-center min-h-screen">
            <div className="text-xl font-semibold text-red-600 bg-red-100 p-4 rounded border border-red-300">
                Error loading product details. Please check the console or try again later.
            </div>
        </div>;
    }
    ...
    return (
        <div className="container mx-auto p-4 md:p-8 bg-gray-50 min-h-screen">
            <h1 className="text-3xl md:text-4xl font-bold mb-8 text-center text-gray-800 border-b pb-4">Product Details</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="bg-blue-50 p-4 rounded-lg">
                            ...
                            <div className={`text-lg font-bold ${stock > 10 ? 'text-green-600' : stock > 0 ? 'text-orange-600' : 'text-red-600'}`}>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg">
                                <div>
                                    ...
                                    <p className="text-gray-900 font-semibold">{brand || 'N/A'}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-900 font-semibold">{seller || 'N/A'}</p>
                                </div>
                                <div>
