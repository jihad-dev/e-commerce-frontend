...
const ViewUserInfo = () => {
    const { id } = useParams();
    const { data: user, isLoading } = useGetSingleUserQuery(id) as { data: UserData | undefined, isLoading: boolean };
                            ...
                            <div className="w-full md:w-1/3">
                                <div className="bg-gray-50 rounded-2xl p-6 text-center">
                                    ...
                                    <div className="mt-4 flex flex-wrap justify-center gap-2">
                                        ...
                                        <span className={`px-4 py-2 text-sm font-medium rounded-full ${user?.status === 'in-progress'
